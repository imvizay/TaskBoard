...
export default function LoginPage() {
    ...
    const credValidation = (loginCredential) => {
        ...
        else if(loginCredential.password.length < 4 || loginCredential.password.length > 12){
            errors['password'] = 'Password must be between 4-12 characters.'
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            localStorage.setItem('taskboard_user',JSON.stringify(res.data?.user))
